  ...
  return (
    <div className="p-2 px-4 m-2 border-2">
      <span className="flex flex-row justify-between mb-2 font-medium">
        <span>FILTERS</span>
        <small className="cursor-pointer" onClick={resetFilters}>
          Clear All
        </small>
      </span>
      ...
      <div className="py-2 pb-4">
        ...
        <Radio.Group
          ...
          options={filters.sortByOption}
          onChange={(e) => setSortBy(e.target.value)}
          value={sortBy}
        />
        <Checkbox className="mt-2" checked={inStock} onChange={(e) => setInStock(e.target.checked)}>
      ...
      <div className="py-2 pb-4">
        ...
        <CheckboxGroup
          className="flex flex-col"
          options={filters.brandFilterOption}
          value={brands}
          onChange={(list) => setBrands(list)}
        />
      </div>
      <Divider className="m-0 mb-1" />
      <div className="py-2 pb-4">
        ...
        <CheckboxGroup
          className="flex flex-col"
          options={filters.idealForOption}
          value={idealFor}
          onChange={(list) => setIdealFor(list)}
        />
      </div>
      <Divider className="m-0 mb-1" />
      <div className="py-2 pb-4">
        ...
        <CheckboxGroup
          className="flex flex-col"
          options={filters.sizesOption}
          value={sizes}
          onChange={(list) => setSizes(list)}
        />
      </div>
      <Divider className="m-0 mb-1" />
      <div className="py-2 pb-4">
        ...
        <CheckboxGroup
          className="flex flex-col"
          options={filters.discountOption}
          value={discounts}
          onChange={(list) => setDiscounts(list)}
        />
      </div>
    </div>
  );
