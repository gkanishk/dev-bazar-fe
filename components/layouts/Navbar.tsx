  ...
  return (
    <nav className="fixed top-0 z-50 flex items-center justify-between w-full px-16 py-4 mb-1 font-medium bg-white nav-bar sm:px-2">
      ...
      <div className="flex items-center justify-between font-medium w-28 sm:ml-1">
        <Link href="/">
          <span className="mx-2 text-base text-gray-800 cursor-pointer hover:underline sm:text-xs">HOME</span>
        </Link>
        <Link href="/products">
          <span className="mx-2 text-base cursor-pointer hover:underline sm:text-xs">PRODUCTS</span>
        </Link>
      </div>
