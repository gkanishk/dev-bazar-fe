...
function LoginForm({ redirectPage, changePage }) {
  ...
  return (
    <Form
      ...
      form={form}
    >
      <span className="block mb-8 text-2xl font-bold text-center">Login</span>
      ...
      <div className="flex justify-center mt-8 mb-4">
        <Button className="mr-2" type="primary" htmlType="submit" loading={isLoginLoading}>
          Login
        </Button>
        <Button loading={isGuestLoginLoading} type="primary" ghost onClick={guestLogin}>
          Guest Login
        </Button>
      </div>
      <div className="flex items-center justify-center">
        Don't have an account?{" "}
        <Button type="link" className="p-0 ml-1" onClick={changePage}>
          Sign-Up
        </Button>
      </div>
    </Form>
